...
indicator! {
    ...
    fn cdl_longleggeddoji(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_longleggeddoji_with_output init zero;
}
...
pub fn cdl_longleggeddoji_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_longleggeddoji_with_output: out length must equal input length".into(),
        ));
    }
    ...
    while i < n {
        ...
        out[i] = if cur_avg_shadow <= val_avg_body
...
indicator! {
    ...
    /// `lookback = 10`.
    fn cdl_longline(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_longline_with_output init zero;
}
...
pub fn cdl_longline_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_longline_with_output: out length must equal input length".into(),
        ));
    }
...
indicator! {
    ...
    fn cdl_matchinglow(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_matchinglow_with_output init zero;
}
...
pub fn cdl_matchinglow_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_matchinglow_with_output: out length must equal input length".into(),
        ));
    }
...
indicator! {
    ...
    fn cdl_mathold(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_mathold_with_output init zero;
}
...
pub fn cdl_mathold_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_mathold_with_output: out length must equal input length".into(),
        ));
    }
    ...
    while i < n {
        ...
        out[i] = if real_body(open[i - 4], close[i - 4]) > val_avg_body_long
            ...
            && body_low(open[i - 2], close[i - 2])
                > close[i - 4] - real_body(open[i - 4], close[i - 4]) * penetration
            && body_low(open[i - 1], close[i - 1])
                > close[i - 4] - real_body(open[i - 4], close[i - 4]) * penetration
...
indicator! {
    ...
    /// `lookback = 12`.
    fn cdl_morningstar(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_morningstar_with_output init zero;
}
...
pub fn cdl_morningstar_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_morningstar_with_output: out length must equal input length".into(),
        ));
    }
...
indicator! {
    ...
    fn cdl_morningdojistar(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_morningdojistar_with_output init zero;
}
...
pub fn cdl_morningdojistar_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_morningdojistar_with_output: out length must equal input length".into(),
        ));
    }
...
indicator! {
    ...
    fn cdl_onneck(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_onneck_with_output init zero;
}
...
pub fn cdl_onneck_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_onneck_with_output: out length must equal input length".into(),
        ));
    }
