...
indicator! {
    ...
    fn cdl_3blackcrows(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_3blackcrows_with_output init zero;
}
...
pub fn cdl_3blackcrows_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_3blackcrows_with_output: out length must equal input length".into(),
        ));
    }
...
indicator! {
    ...
    fn cdl_3inside(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_3inside_with_output init zero;
}
...
pub fn cdl_3inside_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_3inside_with_output: out length must equal input length".into(),
        ));
    }
        ...
        out[i] = if real_body(open[i - 2], close[i - 2]) > val_avg_body_long // 1st long
            ...
            && ((candle_color(open[i - 2], close[i - 2]) == 1.0
                ...
                || (candle_color(open[i - 2], close[i - 2]) == -1.0
                    ...
                    && close[i] > open[i - 2]))
        {
            -candle_color(open[i - 2], close[i - 2]) * 100.0
        } else {
            0.0
        };
        sum_avg_body_long +=
...
indicator! {
    ...
    fn cdl_3linestrike(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_3linestrike_with_output init zero;
}
...
pub fn cdl_3linestrike_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_3linestrike_with_output: out length must equal input length".into(),
        ));
    }
    ...
    while i < n {
        ...
        sum_avg_near_3 +=
            cur_avg_near_3 - high_low_range(high[trail_avg_near_3], low[trail_avg_near_3]);
        trail_avg_near_3 += 1;
        sum_avg_near_2 +=
            cur_avg_near_2 - high_low_range(high[trail_avg_near_2], low[trail_avg_near_2]);
        trail_avg_near_2 += 1;
        i += 1;
    }
...
indicator! {
    ...
    fn cdl_3outside(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_3outside_with_output init zero;
}
...
pub fn cdl_3outside_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_3outside_with_output: out length must equal input length".into(),
        ));
    }
...
indicator! {
    ...
    fn cdl_3starsinsouth(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_3starsinsouth_with_output init zero;
}
...
pub fn cdl_3starsinsouth_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_3starsinsouth_with_output: out length must equal input length".into(),
        ));
    }
...
indicator! {
    ...
    fn cdl_3whitesoldiers(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_3whitesoldiers_with_output init zero;
}
...
pub fn cdl_3whitesoldiers_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_3whitesoldiers_with_output: out length must equal input length".into(),
        ));
    }
    ...
    while i < n {
        ...
        trail_avg_near_2 += 1;
        sum_avg_near_1 +=
            cur_avg_near_1 - high_low_range(high[trail_avg_near_1], low[trail_avg_near_1]);
        trail_avg_near_1 += 1;
        sum_avg_far_2 +=
            cur_avg_far_2 - high_low_range(high[trail_avg_far_2], low[trail_avg_far_2]);
        trail_avg_far_2 += 1;
        sum_avg_far_1 +=
            cur_avg_far_1 - high_low_range(high[trail_avg_far_1], low[trail_avg_far_1]);
        trail_avg_far_1 += 1;
        sum_avg_body_short +=
            cur_avg_body_short - real_body(open[trail_avg_body_short], close[trail_avg_body_short]);
        trail_avg_body_short += 1;
...
indicator! {
    ...
    fn cdl_abandonedbaby(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_abandonedbaby_with_output init zero;
}
...
pub fn cdl_abandonedbaby_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_abandonedbaby_with_output: out length must equal input length".into(),
        ));
    }
    ...
    while i < n {
        ...
        out[i] = if real_body(open[i - 2], close[i - 2]) > val_avg_body_long // 1st long
            ...
            && cur_avg_body_short > val_avg_body_short // 3rd not short
...
indicator! {
    ...
    fn cdl_advanceblock(open: &[f64], high: &[f64], low: &[f64], close: &[f64]) -> Vec<f64> with cdl_advanceblock_with_output init zero;
}
...
pub fn cdl_advanceblock_with_output(
    ...
    if out.len() != open.len() {
        return Err(TaError::BadParam(
            "cdl_advanceblock_with_output: out length must equal input length".into(),
        ));
    }
    ...
    let mut i = lookback;
    while i < n {
        let cur_avg_shadow_short_2 = upper_shadow(open[i - 2], high[i - 2], close[i - 2])
            + lower_shadow(open[i - 2], low[i - 2], close[i - 2]);
        let val_avg_shadow_short_2 = sum_avg_shadow_short_2 / 10 as f64 * 1.0 / 2.0;
        let cur_avg_shadow_short_1 = upper_shadow(open[i - 1], high[i - 1], close[i - 1])
            + lower_shadow(open[i - 1], low[i - 1], close[i - 1]);
        let val_avg_shadow_short_1 = sum_avg_shadow_short_1 / 10 as f64 * 1.0 / 2.0;
        let cur_avg_shadow_short_0 =
        ...
        let _val_avg_shadow_long_1 = cur_avg_shadow_long_1 * 1.0;
        ...
        out[i] = if candle_color(open[i - 2], close[i - 2]) == 1.0 // 1st white
            ...
            && ((real_body(open[i - 1], close[i - 1])
                ...
                && cur_avg_shadow_long_0
                    < real_body(open[i - 1], close[i - 1])
                        + val_avg_near_1) // 2nd far smaller
                || (cur_avg_shadow_long_0
                    < real_body(open[i - 1], close[i - 1])
                        - val_avg_far_1) // 3rd far smaller
                || (cur_avg_shadow_long_0 < real_body(open[i - 1], close[i - 1])
        ...
        sum_avg_shadow_short_2 += cur_avg_shadow_short_2
            - (upper_shadow(
                open[trail_avg_shadow_short_2],
                high[trail_avg_shadow_short_2],
                close[trail_avg_shadow_short_2],
            ) + lower_shadow(
                open[trail_avg_shadow_short_2],
                low[trail_avg_shadow_short_2],
                close[trail_avg_shadow_short_2],
            ));
        trail_avg_shadow_short_2 += 1;
        sum_avg_shadow_short_1 += cur_avg_shadow_short_1
            - (upper_shadow(
                open[trail_avg_shadow_short_1],
                high[trail_avg_shadow_short_1],
                close[trail_avg_shadow_short_1],
            ) + lower_shadow(
                open[trail_avg_shadow_short_1],
                low[trail_avg_shadow_short_1],
                close[trail_avg_shadow_short_1],
            ));
        trail_avg_shadow_short_1 += 1;
        sum_avg_shadow_short_0 += cur_avg_shadow_short_0
            - (upper_shadow(
                open[trail_avg_shadow_short_0],
                high[trail_avg_shadow_short_0],
                close[trail_avg_shadow_short_0],
            ) + lower_shadow(
                open[trail_avg_shadow_short_0],
                low[trail_avg_shadow_short_0],
                close[trail_avg_shadow_short_0],
            ));
        trail_avg_shadow_short_0 += 1;
        sum_avg_shadow_long_1 += cur_avg_shadow_long_1
            - real_body(
                open[trail_avg_shadow_long_1],
                close[trail_avg_shadow_long_1],
            );
        trail_avg_shadow_long_1 += 1;
        sum_avg_shadow_long_0 += cur_avg_shadow_long_0
            - real_body(
                open[trail_avg_shadow_long_0],
                close[trail_avg_shadow_long_0],
            );
